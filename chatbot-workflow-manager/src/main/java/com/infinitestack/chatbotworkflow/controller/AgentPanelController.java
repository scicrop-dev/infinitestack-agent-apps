 ...
 */
@Controller
@RequestMapping("${infinitestack.plugin.base-path:/api/plugins/chatbot-workflow-manager}")
public class AgentPanelController {

    @Value("${infinitestack.plugin.base-path:/api/plugins/chatbot-workflow-manager}")
